...
from sympy import simplify, Symbol, series
import pickle
...
colony_form_data, ring_form_data, plate_maximums = pickle_load("../../Pickles/Data/AC_K_PreprocessedData")
